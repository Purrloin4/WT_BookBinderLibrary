 ...
 */
final class Version20230530204802 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE book_isbn13');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book_isbn13 (id INT DEFAULT NULL, isbn13 VARCHAR(13) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_0900_ai_ci`) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_0900_ai_ci` ENGINE = InnoDB COMMENT = \'\' ');
